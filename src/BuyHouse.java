	...
	public static void house(int a,int player)
	 {
			 ...
			 if(player==1) {
				if(buy[1][a]==0) {
					 ...
					 if(n==JOptionPane.YES_OPTION)
						 {
						 	MainGame.inialmoney1-=Place.getPriceini();
						 	buy[1][a]=1;
						 }
				}
				else {
					...
					if(totalprice==1)
						...
						MainGame.inialmoney1-=Place.getVilla();
				}
			 }
			 else if(player==2) {
				 if(buy[2][a]==0) {
					 if(MainGame.inialmoney2>Place.getPriceini()+200)
						 {
						 	MainGame.inialmoney2-=Place.getPriceini();
						 	buy[2][a]=1;
						 }
				}
				else {
					...
					if(totalprice==1)
						...
						MainGame.inialmoney2-=Place.getVilla();
				}
			 }
		 }
		 else if(buy[player][a]==0&&buy[check][a]!=0)
		 {
			 ...
			 {	
				 ...
				 if(player==2) {
					 if(MainGame.inialmoney2>=Place.getPrice1())
					 {
						 MainGame.inialmoney1+=Place.getPrice1();
						 MainGame.inialmoney2-=Place.getPrice1();
					 }
					 else if(MainGame.inialmoney2<Place.getPrice1())
					 {
						 MainGame.inialmoney1+=Place.getPrice1();
						 MainGame.inialmoney2 -=Place.getPrice1();
					 }
			 ...
			 else if(buy[check][a]==2)
			 {
				 ...
				 if(player==2) {
					 if(MainGame.inialmoney2>=Place.getPrice2())
					 {
						 MainGame.inialmoney1+=Place.getPrice2();
						 MainGame.inialmoney2-=Place.getPrice2();
					 }
					 else if(MainGame.inialmoney2<Place.getPrice2())
					 {
						 MainGame.inialmoney1+=Place.getPrice2();
						 MainGame.inialmoney2 -=Place.getPrice2();
					 }
			 ...
			 else if(buy[check][a]==3)
			 {
				 ...
				 if(player==2) {
					 if(MainGame.inialmoney2>=Place.getPrice3())
					 {
						 MainGame.inialmoney1+=Place.getPrice3();
						 MainGame.inialmoney2-=Place.getPrice3();
					 }
					 else if(MainGame.inialmoney2<Place.getPrice3())
					 {
						 MainGame.inialmoney1+=Place.getPrice3();
						 MainGame.inialmoney2-=Place.getPrice3();
					 }
		 ...
		 else if(buy[player][a]==0)
		 {
			 if(player==1) {
				 ...
				 if(n==JOptionPane.YES_OPTION)
				 {
		 			...
		 			if(MainGame.inialmoney2>Place.getPrice3()+500) {
		 				MainGame.inialmoney2-=Place.getPrice3();
		 				buy[player][a]=3;
		 			}
		 			else if(MainGame.inialmoney2>Place.getPrice2()+200) {
		 				MainGame.inialmoney2-=Place.getPrice2();
		 				buy[player][a]=2;
		 			}
		 			else if(MainGame.inialmoney2>Place.getPrice1()+100) {
		 				MainGame.inialmoney2-=Place.getPrice1();
		 				buy[player][a]=1;
		 			}
				}
			 ...
			 if(buy[player][a]==1) {
				if(player==1) {
					 Object[] options1 = {list[9],list[10],list[11]};
				 		...
				 		{
				 			buy[player][a]=2;
				 			MainGame.inialmoney1-=Place.getPrice1()*2;		
				 		}
					 	else if(n1==JOptionPane.CANCEL_OPTION)
				 		{
					...
					if(MainGame.inialmoney2>Place.getPrice1()*2+500) {
		 				MainGame.inialmoney2-=Place.getPrice1()*2;
		 				buy[player][a]=3;
		 			}
		 			else if(MainGame.inialmoney2>Place.getPrice1()+200) {
		 				MainGame.inialmoney2-=Place.getPrice1();
		 				buy[player][a]=2;
		 			}
				}
			...
			if(player==1) {
				...
				if(MainGame.inialmoney2>Place.getPrice1()+200) {
	 				MainGame.inialmoney2-=Place.getPrice1();
	 				buy[player][a]=3;
	 			}
			}
